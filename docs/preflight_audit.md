...
|---|---|---|---|---|
| **ADPL** | ODSTUPA OD TRŽIŠTA · FALI RAST | 49.00–66.30 (30%) | -47% | cijena -47% vs sredina fer-zone (prag ±40%)<br>raspon sidra 30% > 20% (osjetljivost na r — nije min-max)<br>nekonzistentno sidro: ev_ebitda +103% vs primarno sidro<br>3g prihoda (ima 1: 2025) -> rast se ne izvodi |
| **ADRS** | ODSTUPA OD TRŽIŠTA | 53.50–60.63 (13%) | +189% | cijena +189% vs sredina fer-zone (prag ±40%) |
| **ARNT** | ODSTUPA OD TRŽIŠTA · FALI RAST | 49.48–134.60 (92%) | -56% | cijena -56% vs sredina fer-zone (prag ±40%)<br>raspon sidra 92% > 20% (osjetljivost na r — nije min-max)<br>nekonzistentno sidro: multiples_relative -32% vs primarno sidro<br>nekonzistentno sidro: ev_ebitda -57% vs primarno sidro<br>3g prihoda (ima 1: 2025) -> rast se ne izvodi |
...
| **HPB** | FALI RAST | 326.65–465.35 (35%) | -16% | raspon sidra 35% > 20% (osjetljivost na r — nije min-max)<br>nekonzistentno sidro: residual_income -26% vs primarno sidro<br>placeholder peer multipli (P/E 12, P/B 1,5) u živoj metodi<br>3g prihoda (ima 1: 2025) -> rast se ne izvodi |
| **HT** | FALI RAST · ODSTUPA OD TRŽIŠTA | 54.68–92.08 (51%) | -44% | cijena -44% vs sredina fer-zone (prag ±40%)<br>raspon sidra 51% > 20% (osjetljivost na r — nije min-max)<br>nekonzistentno sidro: multiples_relative -69% vs primarno sidro<br>nekonzistentno sidro: ev_ebitda -41% vs primarno sidro<br>placeholder peer multipli (P/E 12, P/B 1,5) u živoj metodi<br>3g prihoda (ima 1: 2025) -> rast se ne izvodi |
...
| **MAIS** | FALI RAST · ODSTUPA OD TRŽIŠTA | 36.61–49.53 (30%) | +52% | cijena +52% vs sredina fer-zone (prag ±40%)<br>raspon sidra 30% > 20% (osjetljivost na r — nije min-max)<br>nekonzistentno sidro: ev_ebitda +53% vs primarno sidro<br>beta=1,0 pretpostavka (nije izmjerena iz serije)<br>3g prihoda (ima 1: 2025) -> rast se ne izvodi |
| **PLAG** | FALI RAST | 450.78–609.88 (30%) | -36% | raspon sidra 30% > 20% (osjetljivost na r — nije min-max)<br>nekonzistentno sidro: ev_ebitda -34% vs primarno sidro<br>beta=1,0 pretpostavka (nije izmjerena iz serije)<br>3g prihoda (ima 1: 2025) -> rast se ne izvodi |
...
| **RIVP** | FALI RAST · ODSTUPA OD TRŽIŠTA | 4.00–5.41 (30%) | +77% | cijena +77% vs sredina fer-zone (prag ±40%)<br>raspon sidra 30% > 20% (osjetljivost na r — nije min-max)<br>3g prihoda (ima 1: 2025) -> rast se ne izvodi |
...
| **ULPL** | FALI RAST | 137.60–222.51 (47%) | n/p | raspon sidra 47% > 20% (osjetljivost na r — nije min-max)<br>nekonzistentno sidro: multiples_relative -79% vs primarno sidro<br>nekonzistentno sidro: ev_ebitda -51% vs primarno sidro<br>placeholder peer multipli (P/E 12, P/B 1,5) u živoj metodi<br>beta=1,0 pretpostavka (nije izmjerena iz serije)<br>3g prihoda (ima 1: 2024) -> rast se ne izvodi |
| **VLEN** | FALI RAST | 2.23–3.02 (30%) | n/p | raspon sidra 30% > 20% (osjetljivost na r — nije min-max)<br>nekonzistentno sidro: ev_ebitda +136% vs primarno sidro<br>placeholder peer multipli (P/E 12, P/B 1,5) u živoj metodi<br>beta=1,0 pretpostavka (nije izmjerena iz serije)<br>3g prihoda (ima 1: 2025) -> rast se ne izvodi |
...
- firmi s valuacijom: 19; iznad zone: 13, ispod: 6
