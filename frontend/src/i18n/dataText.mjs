...
export const DATA_TX = {
  ...
  // ---- M56: SNBA jednokratna dobit — napomena s priznanjem revizije ----
  "Jednokratna dobit i revizija naše procjene: Slatinska banka je početkom 2025. pripojila drugu banku i u računu dobiti i gubitka za 2025. priznala jednokratnu dobit od povoljne kupnje — stavka 'Ostali prihodi iz redovnog poslovanja' iznosi 23,7 M€, dok je prijašnjih godina bila približno nula (bilanca je u istom kvartalu narasla s 293 na 543 M€, a kapital s 26 na 50 M€). Od prikazane godišnje dobiti od 24,1 M€ ponovljivo je stoga samo oko 0,4 M€. OTVORENO PRIZNAJEMO: naš automatski sustav tu jednokratnu stavku isprva nije uhvatio — povrat na kapital od 47% ušao je u izračun kao da je trajan, pa je fer-zona neko vrijeme stajala na 80–105 € po dionici. Nakon ručne kontrole (1.8.2026.) jednokratna stavka je izuzeta i zona je revidirana na niže — sada počiva na ponovljivoj profitabilnosti banke. Ovakve stavke ubuduće sustavno izuzimamo iz procjene vrijednosti, a tablice financija i pokazatelja i dalje prikazuju službene (prijavljene) brojke.":
    "One-off gain and the revision of our estimate: in early 2025 Slatinska banka merged in another bank and recognised a one-off bargain-purchase gain in its 2025 income statement — the line 'Other income from ordinary operations' amounts to EUR 23.7m, whereas in prior years it was roughly zero (the balance sheet grew from EUR 293m to 543m in the same quarter, and equity from 26 to 50). Of the reported annual profit of EUR 24.1m, only about EUR 0.4m is therefore repeatable. WE OPENLY ACKNOWLEDGE: our automated system initially failed to catch this one-off item — a 47% return on equity entered the calculation as if it were permanent, so the fair zone stood at 80–105 € per share for a while. After a manual review (1 Aug 2026) the one-off item was excluded and the zone was revised downward — it now rests on the bank's repeatable profitability. We now systematically exclude such items from valuation, while the financials and indicator tables continue to show the official (reported) figures.",
  ...
  'kurirana pro-forma procjena postoji samo za grupe u izgradnji čija izvješća još ne obuhvaćaju akvizicije za punu godinu':
    'the curated pro-forma estimate exists only for groups under construction whose reports do not yet cover acquisitions for a full year',
  'peer EV/EBITDA multiplikator nije kalibriran — pro-forma procjena bi počivala na placeholderu':
    'the peer EV/EBITDA multiple is not calibrated — a pro-forma estimate would rest on a placeholder',
  'PRO-FORMA zona (nerevidirani ulazi s izvorima): raspon dolazi iz raspona EBITDA-e — od anualizirane službene polugodišnje brojke do uprávine pro-forma prilagođene EBITDA-e; metode na prijavljenim brojkama ne ulaze u zonu (v. objašnjenje metode)':
    'PRO-FORMA zone (unaudited inputs with sources): the range comes from the EBITDA range — from the annualised official half-year figure to management\'s pro-forma adjusted EBITDA; methods on reported figures do not enter the zone (see the method explanation)',
  'metoda računa na PRIJAVLJENIM brojkama koje akvizicije hvataju tek od datuma preuzimanja — strukturno podcjenjuje grupu u današnjem sastavu; prikazana radi transparentnosti, ne ulazi u fer-zonu':
    'this method runs on REPORTED figures, which capture acquisitions only from the takeover date — it structurally understates the group as composed today; shown for transparency, it does not enter the fair zone',
  'Zašto pro-forma metoda: BOSQAR raste kupovinom firmi, a računovodstvena pravila dopuštaju da se kupljena firma u konsolidirano izvješće uključi tek od datuma preuzimanja. Zato prijavljeni prihod za 2025. iznosi 628 M€, iako bi grupa u današnjem sastavu cijelu godinu prihodovala oko 737 M€ (uprávine pro-forma brojke). Standardne metode na prijavljenim brojkama vrednuju grupu kakva više ne postoji — pola godine s akvizicijama, pola bez, s jednokratnim troškovima integracije. Zato fer-zonu računamo na rasponu EBITDA-e od anualizirane službene polugodišnje brojke (donji rub) do uprávine pro-forma prilagođene EBITDA-e (gornji rub), množimo je medijanom EV/EBITDA usporedivih ZSE grupa, odbijamo neto dug te uzimamo samo dio koji pripada dioničarima BSQR-a — manjinski partneri drže velik dio vertikala. VAŽNO: pro-forma brojke sastavlja uprava i nisu revidirane; kad službena izvješća obuhvate puni opseg grupe, prelazimo na standardne metode.':
    "Why a pro-forma method: BOSQAR grows by acquiring companies, and accounting rules allow an acquired company to enter the consolidated report only from the takeover date. That is why reported 2025 revenue is EUR 628m, even though the group as composed today would have earned about EUR 737m over the full year (management's pro-forma figures). Standard methods on reported figures value a group that no longer exists — half a year with the acquisitions, half without, with one-off integration costs. We therefore compute the fair zone on an EBITDA range from the annualised official half-year figure (lower bound) to management's pro-forma adjusted EBITDA (upper bound), multiply it by the median EV/EBITDA of comparable ZSE groups, deduct net debt, and take only the share belonging to BSQR shareholders — minority partners hold a large part of the verticals. IMPORTANT: pro-forma figures are prepared by management and are unaudited; once official reports cover the group's full scope, we switch to standard methods.",
  'anualizirana službena EBITDA: 2 × H1 2026 (EBIT 12,0 M€ + amortizacija 23,3 M€ = 35,4 M€) = 70,7 M€ — polugodišnje izvješće 31.7.2026. (nerevidirano, EHO objava #68191), bez sezonskih i jednokratnih prilagodbi':
    'annualised official EBITDA: 2 × H1 2026 (EBIT EUR 12.0m + depreciation EUR 23.3m = EUR 35.4m) = EUR 70.7m — half-year report 31 Jul 2026 (unaudited, EHO notice #68191), without seasonal or one-off adjustments',
  'pro-forma prilagođena EBITDA 2025. = 95,0 M€ — Prezentacija za investitore, str. 44 (EHO objava 20.5.2026., #67068): kao da su sve akvizicije u grupi od 1.1., bez jednokratnih troškova; UPRAVINA NEREVIDIRANA BROJKA (uključuje i PIK Vrbovec čije zaključenje još čeka odobrenja)':
    "pro-forma adjusted EBITDA 2025 = EUR 95.0m — Investor Presentation, p. 44 (EHO notice 20 May 2026, #67068): as if all acquisitions had been in the group from 1 Jan, without one-off costs; MANAGEMENT'S UNAUDITED FIGURE (also includes PIK Vrbovec, whose closing still awaits approvals)",
  'neto dug 30.6.2026.: krediti 300,2 + 79,4 − novac 258,6 − kratkoročna fin. imovina 28,3 = 92,7 M€ (polugodišnje izvješće, nerevidirano)':
    'net debt 30 Jun 2026: loans 300.2 + 79.4 − cash 258.6 − short-term financial assets 28.3 = EUR 92.7m (half-year report, unaudited)',
  'kapital matice 200,9 M€ / ukupni kapital 386,8 M€ na 30.6.2026. = 51,9% — knjigovodstveni omjer kao aproksimacija udjela dioničara BSQR-a (manjinski partneri, među njima MidEuropa i EBRD, drže dio vertikala; tržišne cijene tih udjela ne postoje)':
    'parent equity EUR 200.9m / total equity EUR 386.8m at 30 Jun 2026 = 51.9% — book ratio as an approximation of BSQR shareholders\' share of group value (minority partners, among them MidEuropa and the EBRD, hold parts of the verticals; no market prices exist for those stakes)',
  'PRO-FORMA (NEREVIDIRANO): raspon zone dolazi iz raspona EBITDA-e (službena anualizirana → uprávina pro-forma prilagođena), ne iz osjetljivosti na r':
    "PRO-FORMA (UNAUDITED): the zone's range comes from the EBITDA range (official annualised → management's pro-forma adjusted), not from sensitivity to r",
  'medijan EV/EBITDA peer skupa iz baze (ista kalibracija kao za peer usporedbu; skup u \'izvorima pretpostavki\')':
    "median EV/EBITDA of the peer set from our database (same calibration as the peer comparison; the set is listed under 'assumption sources')",
