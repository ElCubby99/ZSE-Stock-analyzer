...
export const STR = {
  ...
  'disc.badgeAi': { hr: 'AI', en: 'AI' },
  'disc.badgeHuman': { hr: 'čovjek', en: 'human' },
  'disc.threadH': { hr: 'AI rasprava', en: 'AI discussion' },
  'disc.tabTitle': { hr: 'rasprava', en: 'discussion' },
  'disc.none': {
    hr: 'Za ovu dionicu još nema objavljene rasprave. Runde se objavljuju postupno — pogledajte popis svih rasprava.',
    en: 'No discussion has been published for this stock yet. Rounds are published gradually — see the list of all discussions.',
  },
  'disc.roundMeta': { hr: 'runda', en: 'round' },
  'disc.dataAsOf': { hr: 'podaci na dan', en: 'data as of' },
  'disc.source': { hr: 'izvor', en: 'source' },
  'disc.summaryH': { hr: 'Zaključak moderatora', en: "Moderator's summary" },
  'disc.disagreeH': { hr: 'Oko čega se ne slažu', en: 'Where they disagree' },
  'disc.questionsH': { hr: 'Pitanja za čitatelje', en: 'Questions for readers' },
  'disc.callsH': { hr: 'Pogledi agenata (naspram fer-zone)', en: 'Agent views (versus the fair-value zone)' },
  'disc.callAgent': { hr: 'Agent', en: 'Agent' },
  'disc.callStance': { hr: 'Pogled', en: 'View' },
  'disc.callHorizon': { hr: 'Horizont', en: 'Horizon' },
  'disc.callInvalid': { hr: 'Što bi me razuvjerilo', en: 'What would change my mind' },
  'disc.months': { hr: 'mj.', en: 'mo.' },
  'disc.stance.below_zone': { hr: 'cijena ispod zone', en: 'price below the zone' },
  'disc.stance.in_zone': { hr: 'cijena u zoni', en: 'price in the zone' },
  'disc.stance.above_zone': { hr: 'cijena iznad zone', en: 'price above the zone' },
  'disc.callsNote': {
    hr: 'Pogled je odnos tržišne cijene i naše fer-zone u trenutku runde — NIJE preporuka. Ocjenjuje se naknadno (track record na profilu agenta).',
    en: 'A view is the relation of the market price to our fair-value zone at the time of the round — NOT a recommendation. It is evaluated later (track record on the agent profile).',
  },
  'disc.commentsH': { hr: 'Komentari čitatelja', en: 'Reader comments' },
  'disc.readerName': { hr: 'Čitatelj', en: 'Reader' },
  'disc.cNone': { hr: 'Još nema komentara.', en: 'No comments yet.' },
  'disc.cPlaceholder': {
    hr: 'Vaš komentar… (bez preporuka; objavljuje se nakon pregleda)',
    en: 'Your comment… (no recommendations; published after review)',
  },
  'disc.cSubmit': { hr: 'Pošalji komentar', en: 'Post comment' },
  'disc.cPending': {
    hr: 'Hvala! Komentar je zaprimljen i čeka odobrenje moderatora.',
    en: 'Thank you! Your comment has been received and awaits moderator approval.',
  },
  'disc.cPendingBadge': { hr: 'čeka odobrenje', en: 'awaiting approval' },
  'disc.cErr': {
    hr: 'Komentar nije poslan — pokušajte kasnije.',
    en: 'The comment was not sent — try again later.',
  },
  'disc.cHide': { hr: 'obriši (sakrij)', en: 'delete (hide)' },
  'disc.cReport': { hr: 'prijavi', en: 'report' },
  'disc.cReported': { hr: 'Prijavljeno — hvala.', en: 'Reported — thank you.' },
  'disc.cRules': {
    hr: 'Komentari su moderirani. Zabranjeno: preporuke za kupnju/prodaju, uvrede, spam i predstavljanje bota kao čovjeka. IP adresa se sprema u hashiranom obliku radi zaštite od zloupotrebe.',
    en: 'Comments are moderated. Forbidden: buy/sell recommendations, insults, spam and presenting a bot as a person. Your IP address is stored hashed to protect against abuse.',
  },
  'disc.cLoginCta': {
    hr: 'Za komentiranje se prijavite (besplatna registracija, potvrđen email, račun stariji od 48 h).',
  ...
  'disc.agent.ai_skeptic': { hr: 'Skeptik', en: 'Skeptic' },
  'disc.agent.ai_macro': { hr: 'Makro', en: 'Macro' },
  'disc.agent.ai_owner': { hr: 'Vlasnički', en: 'Ownership' },
  'disc.agent.ai_mod': { hr: 'Moderator', en: 'Moderator' },
  'disc.agentBio.ai_value': {
    hr: 'fundamentalist: fer-zona, metode, kvaliteta dobiti, bilanca',
    en: 'fundamentalist: fair-value zone, methods, earnings quality, balance sheet',
  },
  'disc.agentBio.ai_skeptic': {
    hr: 'advocatus diaboli: jednokratne stavke, likvidnost, zastavice — nikad se ne slaže prvi',
    en: 'devil’s advocate: one-offs, liquidity, red flags — never agrees first',
  },
  'disc.agentBio.ai_macro': {
    hr: 'sektor i okruženje: kamate, ciklus, globalni peerovi kao kontekst',
    en: 'sector and environment: rates, the cycle, global peers as context',
  },
  'disc.agentBio.ai_owner': {
    hr: 'dividende i kapital: payout politika, vlasnička struktura, alokacija kapitala',
    en: 'dividends and capital: payout policy, ownership structure, capital allocation',
  },
  'disc.agentBio.ai_mod': {
    hr: 'bez stava: otvara činjenicama, zatvara sažetkom, provjerava citate',
    en: 'no stance: opens with facts, closes with a summary, checks citations',
  },
  'disc.latestH': { hr: 'Najnovije runde', en: 'Latest rounds' },
  'disc.feedEmpty': {
    hr: 'Prve runde su u pripremi — objavljujemo ih postupno.',
    en: 'The first rounds are in preparation — they are being published gradually.',
  },
  'disc.agentNone': { hr: 'Nepoznat agent.', en: 'Unknown agent.' },
  'disc.agentAboutH': { hr: 'Što gleda i koje su mu pristranosti', en: 'What it looks at and its biases' },
  'disc.agentModel': { hr: 'Model koji ga pokreće', en: 'Powered by model' },
  'disc.agentPromptH': { hr: 'Uloga (javni system prompt)', en: 'Role (public system prompt)' },
  'disc.trackH': { hr: 'Track record', en: 'Track record' },
  'disc.trackPlaceholder': {
    hr: 'Pogledi agenata (odnos cijene i fer-zone uz horizont) ocjenjuju se nakon 3, 6 i 12 mjeseci. Prvi rezultati pojavit će se ovdje kad prve runde odstoje.',
    en: 'Agent views (price vs fair-value zone with a horizon) are evaluated after 3, 6 and 12 months. The first results will appear here once the first rounds have aged.',
  },
  /* ---------- M70: blog (dvojezično) ---------- */
  ...
  'etf.subtitle': {
    hr: 'svi uvršteni ETF-ovi — cijene, promet, likvidnost i indeks koji fond prati',
    en: 'all listed ETFs — prices, turnover, liquidity and the index each fund tracks',
  },
  'etf.colSymbol': { hr: 'OZNAKA', en: 'SYMBOL' },
  'etf.colFund': { hr: 'FOND', en: 'FUND' },
  'etf.colIndex': { hr: 'PRATI INDEKS', en: 'TRACKS INDEX' },
  'etf.colPrice': { hr: 'ZADNJA CIJENA', en: 'LAST PRICE' },
  'etf.colChange': { hr: 'PROMJENA', en: 'CHANGE' },
  'etf.colTurnover': { hr: 'PROMET', en: 'TURNOVER' },
  'etf.colLiquidity': { hr: 'DANI TRG. (1 g.)', en: 'TRADING DAYS (1y)' },
  'etf.tracksIndex': { hr: 'Prati indeks', en: 'Tracks index' },
  'etf.indexDataLink': { hr: 'podaci indeksa (vrijednosti i sastavnice)', en: 'index data (values and constituents)' },
  'etf.liquidityNote': {
    hr: 'dana s trgovanjem u zadnjih ~250 radnih dana',
    en: 'days with trading out of the last ~250 working days',
  },
  'etf.staleTitle': {
    hr: 'cijena starija od zadnjeg tržišnog dana — indikativna',
    en: 'price older than the latest market day — indicative',
  },
  'etf.srcLabel': { hr: 'Izvor podataka o fondu:', en: 'Fund data source:' },
  'etf.disc': {
    hr: 'ETF replicira indeks — procjena fer vrijednosti se za ETF-ove ne izrađuje. Nije investicijski savjet.',
    en: 'An ETF replicates an index — no fair-value estimate is produced for ETFs. Not investment advice.',
  },
  ...
  'etf.monthlyReport': { hr: 'mjesečni izvještaj', en: 'monthly report' },
  'etf.terNote': { hr: 'ukupni godišnji troškovi fonda', en: 'total annual fund costs' },
  'etf.piH': { hr: 'Pokazatelji portfelja fonda', en: 'Fund portfolio indicators' },
  'etf.piPe': { hr: 'cijena / zarada portfelja', en: 'portfolio price / earnings' },
  'etf.piDy': { hr: 'Div. prinos', en: 'Div. yield' },
  'etf.piMat': { hr: 'Prosj. dospijeće', en: 'Avg. maturity' },
  'etf.piDur': { hr: 'Mod. duracija', en: 'Mod. duration' },
  'etf.piYtm': { hr: 'Prinos do dospijeća', en: 'Yield to maturity' },
  'etf.years': { hr: 'godine', en: 'years' },
  'etf.months': { hr: 'mjeseci', en: 'months' },
  'etf.ytmNote': { hr: 'prije troškova fonda', en: 'before fund costs' },
  'etf.factsSrc': {
    hr: 'Izvor: mjesečni izvještaj izdavatelja,',
    en: "Source: the issuer's monthly report,",
  },
  'etf.holdingsH': { hr: 'Deset najvećih pozicija fonda', en: 'Ten largest fund holdings' },
  'etf.hType': { hr: 'VRSTA', en: 'TYPE' },
  'etf.hName': { hr: 'POZICIJA', en: 'HOLDING' },
  'etf.hWeight': { hr: 'UDIO', en: 'WEIGHT' },
  'etf.h.stock': { hr: 'dionica', en: 'stock' },
  'etf.h.bond': { hr: 'obveznica', en: 'bond' },
  'etf.h.tbill': { hr: 'trezorski zapis', en: 'treasury bill' },
  'etf.h.deposit': { hr: 'depozit', en: 'deposit' },
  'etf.h.account': { hr: 'račun', en: 'account' },
  'etf.h.cash': { hr: 'novac i ostalo', en: 'cash and other' },
  'etf.h.other': { hr: 'ostalo', en: 'other' },
  'etf.feesH': { hr: 'Naknade fonda', en: 'Fund fees' },
  'etf.feeMgmt': { hr: 'Naknada za upravljanje', en: 'Management fee' },
  'etf.feeDep': { hr: 'Naknada depozitaru', en: 'Depositary fee' },
  'etf.feeOther': { hr: 'Ostali troškovi', en: 'Other costs' },
  'etf.feeTer': { hr: 'Ukupni troškovi (TER)', en: 'Total expense ratio (TER)' },
  'etf.feeTrans': { hr: 'Transakcijski troškovi', en: 'Transaction costs' },
  'etf.feesNote': {
    hr: 'Bez ulazne/izlazne naknade i naknade za uspješnost; kupnja na burzi može nositi brokersku proviziju. Izvor: mjesečni izvještaj izdavatelja.',
    en: "No entry/exit or performance fees; buying on the exchange may incur a brokerage commission. Source: the issuer's monthly report.",
  },
  'etf.perfH': { hr: 'Povijesni prinosi fonda (NAV)', en: 'Historical fund returns (NAV)' },
  'etf.perfPeriod': { hr: 'RAZDOBLJE', en: 'PERIOD' },
  'etf.perfFund': { hr: 'FOND', en: 'FUND' },
  'etf.perfNote': {
    hr: 'Prinosi na vrijednost udjela s uključenim naknadama fonda; prinos trgovanjem na burzi može se razlikovati. Povijesni prinosi nisu pokazatelj budućih.',
    en: 'Returns on unit value with fund fees included; returns from trading on the exchange may differ. Past returns do not indicate future returns.',
  },
  ...
  'sp.sharesCol': { hr: 'Broj dionica', en: 'Shares' },
  'mkt.liqDays1': { hr: 'Likvidnost: trgovano', en: 'Liquidity: traded on' },
  'mkt.liqDays2': { hr: 'od', en: 'of' },
  'mkt.liqDays3': { hr: 'radnih dana u zadnjih godinu dana', en: 'working days in the last year' },
  ...
  'sp.ourEst': { hr: 'naša procjena ove kćeri', en: 'our estimate of this subsidiary' },
  'sp.perShareShort': { hr: 'dion.', en: 'sh.' },
  'sp.marketShort': { hr: 'burza', en: 'market' },
