#!/usr/bin/env python3
"""v3 FAZA A: primjena triangulacije sidra i sanity testova na univerzum.
...
Pokretanje: python -m scripts.apply_v3_a
"""
import json
import pathlib
import sys
...
REASON = ("Metodologija v3 — faza A: fer-zona = MEDIJAN kvalificiranih "
          "metoda (triangulacija umjesto jednog sidra) ± osjetljivost "
          "primarnog sidra; test održive dividende (Gordonova donja "
          "granica) s oznakom 'u rekalibraciji'; napomena o zanemarivom "
          "free floatu. Detalji na stranici Metodologija.")
