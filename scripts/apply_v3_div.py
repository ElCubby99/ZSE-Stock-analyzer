#!/usr/bin/env python3
"""v3 FAZA DIV: primjena održive dividende (D_sust u DDM) na univerzum.
...
Pokretanje: python -m scripts.apply_v3_div
"""
import json
import pathlib
import sys
...
REASON = ("Metodologija v3 — faza DIV: dividendni model računa nad "
          "očekivanom ODRŽIVOM dividendom (D_sust = održivi payout × "
          "normalizirana dobit) umjesto nad sirovom zadnjom isplatom; "
          "jednokratne isplate i isplate iz zadržane dobiti ne ulaze u "
          "bazu. Detalji na stranici Metodologija.")
