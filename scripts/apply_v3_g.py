#!/usr/bin/env python3
"""v3 FAZA G: primjena TTM sloja, rasta iz podataka i ROE pravila na univerzum.
...
Pokretanje: python -m scripts.apply_v3_g
"""
import json
import pathlib
import sys
...
REASON = ("Metodologija v3 — faza G: zarada/prihodi/ROE na zadnjih 12 "
          "mjeseci (TTM) gdje kvartali postoje (uz gateove konzistentnosti), "
          "stopa rasta isključivo izvedena iz objavljenih brojki (3g CAGR "
          "cap 10% / kratka serija cap 8%; ručne forward procjene ukinute), "
          "ROE pravilo max(3g medijan, TTM×0,9). Detalji na stranici "
          "Metodologija.")
