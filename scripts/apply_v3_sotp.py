#!/usr/bin/env python3
"""v3 FAZA SOTP: primjena SOTP pravila (standalone/JV/topološki red).
...
Pokretanje: python -m scripts.apply_v3_sotp
"""
import json
import pathlib
import sys
...
REASON = ("Metodologija v3 — faza SOTP: standalone dio matice vrednuje se "
          "isključivo iz nekonsolidiranih izvještaja (bez toga 'u obradi', "
          "ne aproksimira se iz konsolidiranih); neuvršteni JV po "
          "knjigovodstvenoj vrijednosti iz bilješki (KPT: 44,2 M€, GI 2025 "
          "bilj. 16); preračun topološkim redom (kćeri prije matica). "
          "Detalji na stranici Metodologija.")
